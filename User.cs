...
namespace SkeletonFinalApp
{
    ...
    public class User
    {
        ...
        // Virtual method to return the role of the user
        // In a real banking application, the customer and admin interfaces would typically
        // be separate applications, so this method mainly serves to demonstrate polymorphism
